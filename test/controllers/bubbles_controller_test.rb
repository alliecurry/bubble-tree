...
class BubblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bubble" do
    assert_difference('Bubble.count') do
      post bubbles_url, params: { bubble: { description: @bubble.description, name: @bubble.name, tree_id: @bubble.tree_id } }
    end
  ...
  test "should update bubble" do
    patch bubble_url(@bubble), params: { bubble: { description: @bubble.description, name: @bubble.name, tree_id: @bubble.tree_id } }
